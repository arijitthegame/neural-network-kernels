...
parser = argparse.ArgumentParser(description="PEFT Finetuning on GLUE on 1 GPU")
parser.add_argument("--seed", default=42, type=int)
parser.add_argument("--batch_size", default=32, type=int)
parser.add_argument(
    "--model_name_or_path", default="roberta-large", type=str
)  # can use roberta-base or other bert models
...
parser.add_argument(
    "--ckpt_criterion", type=str, default="accuracy", choices=["accuracy", "f1"]
)
...
lr_scheduler = get_linear_schedule_with_warmup(
    ...
    * (len(train_dataloader) * num_epochs),  # kinda hardcoded. #TODO:fix
...
inference_model = PeftModel.from_pretrained(
    inference_model, peft_model_id
)  # possible bug in this loading
