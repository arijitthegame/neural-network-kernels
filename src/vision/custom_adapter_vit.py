...
class CustomAdapterViTLayer(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.output = CustomAdapterViTOutput(
            self.config,
            self.num_rfs,
            self.A_fun,
            self.a_fun,
        ...
        self.attention_adapters = CustomAdapter(
...
class CustomAdapterViTModel(ViTModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.encoder = CustomAdapterViTEncoder(
            config=self.config,
            num_rfs=self.num_rfs,
            A_fun=self.A_fun,
            a_fun=self.a_fun,
...
class CustomAdapterViTForImageClassification(ViTForImageClassification):
    def __init__(
        ...
        self.vit = CustomAdapterViTModel(
            config=config,
            num_rfs=self.num_rfs,
            A_fun=self.A_fun,
            a_fun=self.a_fun,
